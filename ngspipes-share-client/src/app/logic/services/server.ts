export class Server {
    ...
    public static GET_USER_IMAGE : string = Server.AUTHENTICATION_SERVER_URI + "/images/users" + "/{userName}";
    public static UPDATE_USER_IMAGE : string = Server.AUTHENTICATION_SERVER_URI + "/images/users" + "/{userName}";
    public static DELETE_USER_IMAGE : string = Server.AUTHENTICATION_SERVER_URI + "/images/users" + "/{userName}";

    public static GET_GROUP_IMAGE : string = Server.AUTHENTICATION_SERVER_URI + "/images/groups" + "/{groupName}";
    public static UPDATE_GROUP_IMAGE : string = Server.AUTHENTICATION_SERVER_URI + "/images/groups" + "/{groupName}";
    public static DELETE_GROUP_IMAGE : string = Server.AUTHENTICATION_SERVER_URI + "/images/groups" + "/{groupName}";

    public static GET_TOOLS_REPOSITORY_IMAGE : string = Server.TOOLS_REPOSITORY_SERVER_URI + "/images/toolsRepository" + "/{repositoryId}";
    public static UPDATE_TOOLS_REPOSITORY_IMAGE : string = Server.TOOLS_REPOSITORY_SERVER_URI + "/images/toolsRepository" + "/{repositoryId}";
    public static DELETE_TOOLS_REPOSITORY_IMAGE : string = Server.TOOLS_REPOSITORY_SERVER_URI + "/images/toolsRepository" + "/{repositoryId}";
