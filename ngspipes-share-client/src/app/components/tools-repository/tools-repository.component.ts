...
@Component({
    ...
    styleUrls: ['./tools-repository.component.scss']
})
export class ToolsRepositoryComponent implements OnInit, OnDestroy {
    ...
    constructor(private repositoryService : ToolsRepositoryService,
    ...
    ngOnInit() {
        ...
        this.repositorySubscription = this.repositoryService.toolsRepositoryEvent.subscribe((repositoryId) => {
    ...
    loadRepository() : Promise<ToolsRepository> {
